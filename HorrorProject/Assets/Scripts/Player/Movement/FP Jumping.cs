...
public class FPJumping : MonoBehaviour
{
    ...
    void OnBeforeMove()
    {
        ...
        bool canJump = jumpAllowed && isOrWasTryingToJump && isOrWasGrounded && !crouchController.IsCrouching && !controller.isPaused && !controller.isAtKeypad && !controller.isAtPC && !controller.isInspectingDocument;
